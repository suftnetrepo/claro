      ...
      >
        ...
        >
          ...
          <StyledPressable
            ...
            borderRadius={16}
            backgroundColor={
              isNow ? "rgba(255,255,255,0.1)" : "rgba(255,255,255,0.2)"
            }
            alignItems="center"
            justifyContent="center"
            onPress={nextMonth}
          ...
          >
            <ChevronRightIcon
              size={16}
              color={isNow ? "rgba(255,255,255,0.35)" : Colors.white}
              strokeWidth={2.5}
            />
          </StyledPressable>
        </Stack>
    ...
    <Stack horizontal gap={12} paddingHorizontal={20} paddingVertical={16}>
      ...
      >
        <Stack
          ...
          marginBottom={10}
        >
          <Text variant="label" color={Colors.expense}>
            Expense
          </Text>
          <Stack
            width={28}
      ...
      >
        <Stack
          ...
          marginBottom={10}
        >
          <Text variant="label" color={Colors.income}>
            Income
          </Text>
          <Stack
            width={28}
