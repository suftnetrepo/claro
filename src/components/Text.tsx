...
/**
 * Claro Typography System
 *
 * Centralized Text component with semantic variants for consistent typography.
 * Automatically maps fontWeight to the correct Plus Jakarta Sans variant.
 *
 ...
 * - overline: 12px/700 — Small uppercase section markers (e.g., "CHOOSE YOUR PLAN")
 *
 * USAGE EXAMPLES:
