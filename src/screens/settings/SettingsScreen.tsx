...
function SettingsRow({
  ...
  return (
    ...
    >
      ...
      {value && !loading && (
        <Text variant="subLabel" color={Colors.textMuted} marginRight={4}>
          {value}
        </Text>
      )}
      {loading ? (
      ...
      renderItem={({ item }) => {
        ...
        return (
          ...
          >
            ...
            {isSelected && (
              <CheckIcon size={18} color={Colors.primary} strokeWidth={2.5} />
            )}
          </StyledPressable>
        );
      }}
...
export default function SettingsScreen() {
  ...
  const handleResetPremium = useCallback(async () => {
    const ok = await dialogueService.confirm({
      title: "Reset premium?",
      message: "Remove premium entitlement for testing.",
      icon: "🧪",
      confirmLabel: "Reset",
      destructive: true,
    });
  ...
  const handleResetApp = useCallback(async () => {
    const ok = await dialogueService.confirm({
      title: "Reset app?",
      message:
        "This will delete your PIN and all settings. You will go through setup again.",
      icon: "⚠️",
      confirmLabel: "Reset",
      destructive: true,
    });
        ...
        <StyledScrollView contentContainerStyle={{ paddingBottom: 48 }}>
          ...
          <Stack marginHorizontal={16} marginTop={12} marginBottom={4}>
            {!premium.isPremium ? (
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text variant="label" fontSize={13} color="#fff">
                        View →
                      </Text>
                    </Stack>
                  </Stack>
              ...
              >
                ...
                <Stack flex={1}>
                  <Text variant="label" fontSize={14} color={Colors.primary}>
                    Claro Premium
                  </Text>
          ...
          <SettingsGroup>
            ...
            <SettingsRow
              ...
              onPress={() =>
                premium.canExport() && !exportingJSON
                  ? handleExportJSON()
                  : !premium.canExport()
                    ? router.push("/premium" as any)
                    : undefined
