    ...
    >
      ...
      >
        ...
        >
          ...
          <StyledDivider borderBottomColor={Colors.border} marginHorizontal={24} marginVertical={16} />

          {/* Subscription notice */}
          <Stack paddingHorizontal={24} marginBottom={24}>
            <StyledText fontSize={11} color={Colors.textMuted} textAlign="center" lineHeight={16}>
              {'trial' in pricing
                ? `Your ${pricing.trial} begins today. After the trial, you will be charged ${pricing.price} ${pricing.period} unless you cancel before the trial ends.`
                : plan === 'ONE_TIME'
